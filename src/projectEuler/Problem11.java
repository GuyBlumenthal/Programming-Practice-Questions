...
public class Problem11 {
	...
	final static String[][] Numbers = { ("08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08").split(" "),
	...
	public static void main(String[] args) {
		...
		for (int row = 0; row < 20; row++) {
			...
			for (int column = 0; column < 13; column++) {
				...
				for (int k = column; k < column + 4; k++) {
					product *= Integer.parseInt(Numbers[row][k]);
				}
		...
		for (int row = 0; row < 17; row++) {
			...
			for (int column = 0; column < 20; column++) {
				...
				for (int k = row; k < row + 4; k++) {
					product *= Integer.parseInt(Numbers[k][column]);
				}
		...
		for (int row = 0; row < 17; row++) {
			...
			for (int column = 0; column < 17; column++) {
				...
				long product = 1;
				for (int k = 0; k < 4; k++) {
					product *= Integer.parseInt(Numbers[row + k][column + k]);
				}
